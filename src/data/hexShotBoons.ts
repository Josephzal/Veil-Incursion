...
export const HEX_SHOT_BOON_CATALOG: Record<HexShotBoonId, ClassBoonDefinition> = {
  ...
  RECOIL_HARNESS: hex('RECOIL_HARNESS', 'TIER_1', 'Recoil Harness', 'Ballistic attacks cost 50% less Stamina.', 'BALLISTIC // −50% stamina cost', 'passive', { tagAll: ['BALLISTIC'] }),
  ...
  AUTO_LOADER_DECK: hex('AUTO_LOADER_DECK', 'TIER_3', 'Auto-Loader Deck', 'Start combat with full Magazine and OVERCHARGED.', 'onEncounterStart // full mag + overcharged', 'onEncounterStart'),
