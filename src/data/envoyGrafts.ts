...
export const ENVOY_GRAFT_DATABASE: Record<EnvoyGraftId, ClassGraftDefinition> = {
  VOID_CONDUCTOR_GRAFT: env(
    ...
    20,
    'Damage ×2.0. +20% additional Veil-Flux cost.',
    '#a78bfa',
    { damageMultiplier: 2, addFluxCost: 20 },
  ),
  ...
  AETHER_VALVE_GRAFT: env(
    ...
    'Aether-Valve Graft',
    25,
    'Restores 15% Veil-Flux instead of consuming. Damage ×0.8.',
    '#22d3ee',
    { setFluxRegen: 15, setFluxCost: 0, damageMultiplier: 0.8 },
  ),
  SANGUINE_CHANNEL_GRAFT: env(
    'SANGUINE_CHANNEL_GRAFT',
    'Sanguine-Channel Graft',
    20,
    '0% Flux cost. Drains 10% Max HP on cast.',
    '#f87171',
    { setFluxCost: 0, addHpCost: 0.1 },
  ),
  ECHO_WEAVE_GRAFT: env(
    'ECHO_WEAVE_GRAFT',
    'Echo-Weave Graft',
    30,
    'Kills refund 1 AP. +10% Veil-Flux cost.',
    '#c084fc',
    { refundApOnKill: true, addFluxCost: 10 },
  ),
  NULL_STATE_GRAFT: env(
    'NULL_STATE_GRAFT',
    'Null-State Graft',
    15,
    '0 AP cost. Drains 40% Veil-Flux on cast.',
    '#67e8f9',
    { setApCost: 0, setFluxCost: 40 },
  ),
  ...
  WITHER_MARK_GRAFT: env(
    ...
    'Wither-Mark Graft',
    20,
    'Target loses 1 AP next turn. +15% Veil-Flux cost.',
    '#84cc16',
    { applyDebuffToTarget: 'AP_MINUS_1', addFluxCost: 15 },
  ),
  ...
  OVERLOAD_CATALYST_GRAFT: env(
    ...
    30,
    'Damage scales with missing Veil-Flux (replaces base damage).',
    '#fbbf24',
    { damageScale: 'MISSING_FLUX' },
  ),
  MARTYR_RUNE_GRAFT: env(
    'MARTYR_RUNE_GRAFT',
    'Martyr-Rune Graft',
    20,
    'Converts to AoE. Operative takes 15 True self-damage.',
    '#fda4af',
  ...
  APEX_CHANNEL_GRAFT: env(
    ...
    'Apex-Channel Graft',
    45,
    'Executes non-bosses under 20% HP. ×2 damage vs bosses. Disables Cataclysm.',
    '#fde047',
    { executeThreshold: 0.2, disableUltimate: true, bossDamageMultiplier: 2 },
  ),
};
