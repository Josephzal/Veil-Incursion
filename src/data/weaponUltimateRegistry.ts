...
export const WEAPON_ULTIMATE_BY_FAMILY: Record<WeaponFamilyId, WeaponUltimateRecord> = {
  ...
  'aegis-claymore-blade': {
    ...
    legacyClassUltimateIds: [],
    status: 'WIRED',
    interactionSummary: 'Unmaker — raise / strain / slam; cash existing Fracture; PERFECT narrow shockwave.',
  },
  ...
  'envoy-sanguine-prism': {
    ...
    legacyClassUltimateIds: [],
    status: 'WIRED',
    interactionSummary: "Heart's Due — align / offer / commit; brink + full-pay HP sacrifice.",
  },
};
