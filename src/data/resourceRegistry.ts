...
export const RESOURCE_REGISTRY: Record<ResourceItemId, ResourceItemDefinition> = {
  ...
  'cinder-wire': def({
    ...
    rarity: 'COMMON',
    sourceHint: 'Ashen Wastes roadside caches, Sapper / Splinter fights, false extraction roads.',
  ...
  'overgrowth-coordinate': def({
    id: 'overgrowth-coordinate',
    name: 'Overgrowth Coordinate',
    shortName: 'Overgrowth Coord',
    description:
      'Living route intel for the Abyssal Sink. Extract intact to stabilize a breach vector — not for fencing.',
    category: 'INTEL',
    primaryRole: 'ROUTE_INTEL',
    usageTags: ['INTEL', 'ROUTE_INTEL', 'SECTOR_ACCESS_INTEL', 'SCANNER_INTEL'],
    rarity: 'RARE',
    sourceHint: 'Null Zone Depth 1 boss / elite salvage while Abyssal Sink access mandate is active.',
  ...
  'false-road-signal': def({
    id: 'false-road-signal',
    name: 'False-Road Signal',
    shortName: 'False-Road Sig',
    description:
      'Ashen Wastes route beacon. Distorted road intel — extract to open the Edge Roads breach.',
    category: 'INTEL',
    primaryRole: 'ROUTE_INTEL',
    usageTags: ['INTEL', 'ROUTE_INTEL', 'SECTOR_ACCESS_INTEL', 'SCANNER_INTEL'],
    rarity: 'RARE',
    sourceHint: 'Null Zone or Abyssal Sink Depth 2 events while Ashen Wastes mandate is active.',
    ...
    canOpenAtHub: false,
    canOpenInRun: false,
    validSectorIds: ['THE_NULL_ZONE', 'THE_ABYSSAL_SINK'],
  }),
  'transit-cipher': def({
    id: 'transit-cipher',
    name: 'Transit Cipher',
    shortName: 'Transit Cipher',
    description:
      'Industrial route map fragment for the Slag Works. Bulky intel — extract, do not fence.',
    category: 'INTEL',
    primaryRole: 'ROUTE_INTEL',
    usageTags: ['INTEL', 'ROUTE_INTEL', 'SECTOR_ACCESS_INTEL', 'SCANNER_INTEL'],
    rarity: 'APEX',
    sourceHint: 'Ashen Wastes or Null Zone Depth 2 elite caches while Slag Works access mandate is active.',
    ...
    canOpenAtHub: false,
    canOpenInRun: false,
    validSectorIds: ['THE_ASHEN_WASTES', 'THE_NULL_ZONE'],
  }),
  'blackline-credentials': def({
    id: 'blackline-credentials',
    name: 'Blackline Credentials',
    shortName: 'Blackline Creds',
    description:
      'Blacksite clearance wafer for Blackline Terminus. Lost on death if unextracted.',
    category: 'INTEL',
    primaryRole: 'ROUTE_INTEL',
    usageTags: ['INTEL', 'ROUTE_INTEL', 'SECTOR_ACCESS_INTEL', 'SCANNER_INTEL'],
    rarity: 'APEX',
    sourceHint: 'Slag Works or Ashen Wastes Depth 3 boss-adjacent events while Blackline mandate is active.',
    ...
    canOpenAtHub: false,
    canOpenInRun: false,
    validSectorIds: ['THE_SLAG_WORKS', 'THE_ASHEN_WASTES'],
  }),
};
