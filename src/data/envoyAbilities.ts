...
export const ENVOY_ABILITY_CATALOG: Record<EnvoyAbilityId, EnvoyAbilityDefinition> = {
  VEIL_SPLINTER: {
    ...
    classId: 'ENVOY',
    label: '[ VEIL-SPLINTER ]',
    description: 'Anchor spell — applies 1 Veil Rot stack. Cannot be removed or grafted.',
    apCost: 1,
    fluxCost: 5,
    fluxRegen: 0,
    staminaCost: 6,
  ...
  DIMENSIONAL_SHEAR: {
    ...
    description: 'Strips all Occult Wards and applies 1 Veil Rot stack.',
    apCost: 2,
    fluxCost: 20,
    fluxRegen: 0,
    staminaCost: 12,
  ...
  RIFT_WARD: {
    ...
    classId: 'ENVOY',
    label: '[ RIFT-WARD ]',
    description: 'Defensive hold & release — perfect block restores flux.',
    apCost: 1,
    fluxCost: 0,
    fluxRegen: 0,
    staminaCost: 0,
