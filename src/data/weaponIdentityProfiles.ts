...
export const WEAPON_IDENTITY_PROFILES: Record<WeaponFamilyId, WeaponIdentityProfile> = {
  ...
  'hex-silver-core-sidearm': {
    ...
    meterSummary: 'Standard magazine; Perfect Reload → Protocol Charge → Zero Protocol.',
  ...
  'hex-pulse-rifle': {
    ...
    meterSummary: 'Tighter mag than old sustained fantasy; frequent reload; empty-mag is part of the loop.',
    ...
    debugNotes: 'Player-facing name Carbine; Zero Protocol ultimate binds to this family only.',
  },
  'hex-void-cannon': {
    id: 'hex-void-cannon',
    classId: 'HEX_SHOT',
    liveDisplayName: 'Black Door',
    plannedDisplayName: null,
