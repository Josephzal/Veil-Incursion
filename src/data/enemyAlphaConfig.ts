...
export const ENEMY_ALPHA_CONFIG: Record<EncounterEnemyKey, AlphaModifiers> = {
  ...
  SCUTTLER: alpha('Apex', { evadeChance: 0.30 }),
  SPALL: alpha('Volatile', { explosionDamage: 30, piercesDefend: true }),
  THRALL: alpha('Undying', { reviveTurns: 1, reviveHpPercent: 0.4 }),
  ...
  REMEMBERING_THRALL: alpha('Remembered', { reviveTurns: 1, reviveHpPercent: 0.4 }),
