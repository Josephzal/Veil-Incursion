...
const PRIMITIVE_HANDLERS: Record<EffectPrimitive['kind'], PrimitiveHandler> = {
  ...
  BROKEN_OUTCOME: chosenFateMarker,
  BREAKING_MEASURE: chosenFateMarker,
  ECHOED_FAULT: chosenFateMarker,
  CRITICAL_PRESSURE: chosenFateMarker,
  SPLIT_SEAM: chosenFateMarker,
  PAIN_FORETOLD: chosenFateMarker,
  PULSE_RITE: chosenFateMarker,
  PHANTOM_PAIN: chosenFateMarker,
  HELD_BREATH: chosenFateMarker,
  SYMPATHETIC_WOUND: chosenFateMarker,
  LIVING_FAULT: chosenFateMarker,
  GRAVEMARK_IMPACT_VECTOR: chosenFateMarker,
  GRAVEMARK_FOLDED_SPACE: chosenFateMarker,
  GRAVEMARK_REVERSAL_FIELD: chosenFateMarker,
  GRAVEMARK_MASS_TRANSFER: chosenFateMarker,
  GRAVEMARK_COLLISION_COURSE: chosenFateMarker,
  GRAVEMARK_FALSE_POSITION: chosenFateMarker,
  GRAVEMARK_EVENT_HORIZON: chosenFateMarker,
  GRAVEMARK_WORLD_TURNED_SIDEWAYS: chosenFateMarker,
  SHARDSKIN_CRYSTAL_EDGE: chosenFateMarker,
  SHARDSKIN_RITUAL_PANE: chosenFateMarker,
  SHARDSKIN_PERFECT_FACET: chosenFateMarker,
  SHARDSKIN_PRESSURE_CRYSTAL: chosenFateMarker,
  SHARDSKIN_TEMPERED_REMNANT: chosenFateMarker,
  SHARDSKIN_SCATTERGLASS: chosenFateMarker,
  SHARDSKIN_ENDLESS_FACET: chosenFateMarker,
  SHARDSKIN_CATHEDRAL_BREAK: chosenFateMarker,
  FATE_OUT_OF_PLACE: chosenFateMarker,
  TURNING_RITE: chosenFateMarker,
  PARALLAX_ECHO: chosenFateMarker,
  STORED_VECTOR: chosenFateMarker,
  TETHERED_ORBIT: chosenFateMarker,
  TECTONIC_SHIFT: chosenFateMarker,
  TRAUMA_VECTOR: chosenFateMarker,
  FATED_FACET: chosenFateMarker,
  PRISMATIC_RITE: chosenFateMarker,
  PHANTOM_FACET: chosenFateMarker,
  STILLGLASS: chosenFateMarker,
  CRYSTAL_LIGATURE: chosenFateMarker,
  FAULTGLASS: chosenFateMarker,
  SOULGLASS: chosenFateMarker,
  IMPACT_LATTICE: chosenFateMarker,
};
