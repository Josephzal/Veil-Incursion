...
export const NINE_STRAIN_SCHEMA_VERSION = 11;

export const SECTOR_1_LIVE_STRAINS = ['COUNTERFATE', 'RITUAL_CADENCE', 'AFTERIMAGE'] as const;

export const SECTOR_2_LIVE_STRAINS = ['STILLPOINT', 'WOUNDWEAVE'] as const;
