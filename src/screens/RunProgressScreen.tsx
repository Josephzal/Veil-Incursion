        ...
        <ScrollView style={styles.scroll} contentContainerStyle={styles.scrollContent}>
          ...
          <View style={[styles.panel, { borderColor: theme.borderColor }]}>
            ...
            {recentLogs.map((line, idx) => (
              <Text key={`${idx}-${line.slice(0, 16)}`} style={[styles.logLine, { color: accent }]}>
                {line}
              </Text>
            ))}
          </View>
...
const styles = StyleSheet.create({
  container: { flex: 1 },
  header: { borderBottomWidth: 1, paddingVertical: 12, paddingHorizontal: 16 },
  ...
  statLine: { fontFamily: 'monospace', fontSize: 9, marginBottom: 4, letterSpacing: 0.4 },
  meterTrack: { height: 6, borderWidth: 1, marginBottom: 10, backgroundColor: '#0a0b0f', overflow: 'hidden' },
  meterFill: { height: '100%' },
  logLine: { fontFamily: 'monospace', fontSize: 8, lineHeight: 12, marginBottom: 3 },
  continueBtn: { borderWidth: 2, marginHorizontal: 16, marginBottom: 8, paddingVertical: 14, alignItems: 'center' },
