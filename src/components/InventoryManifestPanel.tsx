...
function LedgerLine({
  ...
  label: string;
  value: string;
  theme: { mutedColor: string; textColor: string };
}) {
  return (
...
export default function InventoryManifestPanel(): React.JSX.Element {
  ...
  return (
    <ScrollView style={styles.scroll} contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
      <Text style={[styles.panelTitle, { color: theme.primaryColor }]}>ASSET MANIFEST // INVENTORY LEDGER</Text>
...
const styles = StyleSheet.create({
  ...
  panelTitle: { fontFamily: 'monospace', fontSize: 9, fontWeight: '700', letterSpacing: 1, marginBottom: 12 },
